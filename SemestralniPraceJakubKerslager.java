...
/**
 * Asks user to write two sets of positive numbers, negative number stops adding more numbers. 
 */
...
/**
 * Fills list with positive integers, negative number finishes adding, it is not part of the list 
 */
private static List filled(List a){
    a.clear();
    boolean adding = true;
    int num;    
