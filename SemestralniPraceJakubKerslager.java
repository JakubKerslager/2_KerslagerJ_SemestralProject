...
/**
 * Asks user to write first set of positive numbers, negative number stops adding more numbers. 
 */
private static void firstSequence(){
...
/**
 * Asks user to write second set of positive numbers, negative number stops adding more numbers. 
*/
private static void secondSequence(){
 ...
 */
private static void longestSamePart(){
    int[] A = listToArray(a);
    int[] B = listToArray(b);
    for (int i = 0; i < A.length; i++) {
        for (int j = 0; j < B.length; j++) {
            if (A[i]==B[j]){                              
                if (longest < samePart(A,B,i,j)){
                    longest = samePart(A,B,i,j);    
                }    
            }   
        }
    }    
    ...
    /**This method converts list of integers to array
     * @param list
     * @return Array
     */
...
return Array;    
    ...
    /**
     * This method goes trough 2 arrays from specific indexes and counts for how long they are identical
     * @param Array1
     * @param Array2
     * @param indexOfArray1
     * @param indexOfArray2
